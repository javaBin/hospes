...
object CreateMembers {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val jsonContentTypes = Map("Content-Type" -> "application/json", "Accept" -> "application/json")
    Http x ("http://localhost:8080/rest/memberships" << pretty(render(json)) <:< jsonContentTypes as_! ("webshop", "webschopp") >|) {
